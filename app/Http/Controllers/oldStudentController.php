...
//        }
    ...
    public function index(Request $request, SystemController $sys) {
        ...
        if ($request->has('class') && trim($request->input('class')) != "") {
            $student->where("currentClass", $request->input("currentClass", ""));
        }
            ...
            if (in_array($ext, $valid_exts)) {
                ...
                if (!empty($data) && $data->count()) {
                    foreach ($data as $key => $value) {
                        ...
                        $phone = $value->phone;
                        $preschool= $value->previous_school;
                        $house = $value->house;
                        $classAdmitted = $value->class_admitted;
                        $religion = $value->religion;
                        $residence = $value->residence_address;
                        $contact = $value->contact_address;
                        $disability = $value->disability;
                        $email = $value->email;
                        $electives = $value->subject_combinations;
                        $admittedDate = $value->date_admitted;
                        $scholarship = $value->is_scholarship;
...
//                        if (array_search($program, $programme)) {
                            ...
                            if (empty($testQuery)) {
                                ...
                                $student->classAdmitted =$classAdmitted;
                                ...
                                $student->email =$email;
                                $student->formerSchool =$preschool;
                                $student->programme =$sys->getProgramCode($program);
                                $student->house =$house;
                                $student->nationality =$nationality;
                                $student->dateAdmitted =$admittedDate;
                                ...
                                $student->subjectCombination =$electives;
